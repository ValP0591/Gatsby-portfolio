      ...
      <footer className={footerStyles.footer}>
          ...
          style={{
              ...
              >This site is made with Gatsby. If you`d like to know how it works please be sure to <Link to ="/contact" style={{
                ...
                <text fill="#ECB613" font-family="Lato, HelveticaNeue, Helvetica Neue, Helvetica, Arial, sans-serif" font-size="10" x="20" y="12" text-anchor="middle" transform="translate(28 1)">6 kyu</text>
                ...
                <text fill="#262626" font-family="Lato, HelveticaNeue, Helvetica Neue, Helvetica, Arial, sans-serif" font-size="12" x="111" y="14.5" text-anchor="end">168</text>
