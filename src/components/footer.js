      ...
      <footer className={footerStyles.footer}>
          ...
          style={{
              ...
              >This site is made with Gatsby. If you`d like to know how it works please be sure to <Link to ="/contact" style={{
                ...
                <path fill="#E4E4E4" d="M114.226 20L120 10l-5.774-10H15.774v20z"/>
                <path fill="#FAFAFA" opacity=".99" d="M5.774 20L0 10 5.774 0H64.97l5.773 10-5.773 10z"/>
                <path fill="#F5F5F5" d="M63.51 17.36L67.606 10 63.51 2.64H34.05L29.951 10l4.097 7.36z"/>
                <text fill="#ECB613" font-family="Lato, HelveticaNeue, Helvetica Neue, Helvetica, Arial, sans-serif" font-size="10" x="20" y="12" text-anchor="middle" transform="translate(28 1)">5 kyu</text>
                <path fill="#ECB613" d="M33.196 19L28 10l5.196-9h31.177l5.196 9-5.196 9H33.196zm29.966-2.078l4-6.922-4-6.922H34.397l-4 6.922 4 6.922h28.765z"/>
                <text fill="#262626" font-family="Lato, HelveticaNeue, Helvetica Neue, Helvetica, Arial, sans-serif" font-size="12" x="111" y="14.5" text-anchor="end">370</text>
